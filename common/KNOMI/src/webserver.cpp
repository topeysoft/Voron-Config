...
void webserver_setup(void)
{
    ...
    server.on("/", HTTP_POST, [](AsyncWebServerRequest *request)
        ...
        {
            request->send(200, "text/html", "KNOMI is resetting, please wait for the process to complete. Once completed, you will need to reconnect to the BTT-KNOMI access point. <br><a href=\"/\">Return to Home Page</a>");
        }
        else
        {
            request->send_P(200, "text/html", index_html, knomi_html_processor);

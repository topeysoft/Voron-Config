...
<head>
  ...
  <script>
      ...
      function validateResetForm(){
       return prompt("You are bout to reset the BTT KNOMI to factory settings.\n\nTo confirm, please type 'reset' in the box below.") == "reset";
      }
...
<body>
  ...
  <div class="content">
      ...
      <div class="card">
        <form name="wifidata" action="/" method="POST">
          ...
          <div class="ant-form-item-row">
            ...
            <div class="ant-form-item-control">
              <input type="text" id ="klipper" name="klipper" $klipper$  maxlength="20"><br>
            </div>
            <input type ="submit" id="submitwifi" value ="Submit">
          </div>
        </form>
    ...
    <div class="card-grid">
      <div class="card">
         <!-- <br><label id="FRESET">Factory Reset</label><br><br><br> -->
        <form name="factoryReset" action="/" method="POST" onsubmit="return validateResetForm()">
          <button type ="submit" id="FRstBtn" name="reset" value="Factory Reset"><span>Factory Reset</span></button>
        </form>
      </div>
    </div>
  </div>

...
char *startup_sound = "Super Mario:d=4,o=5,b=100:16e6,16e6,32p,8e6,16c6,8e6,8g6,8p,8g,8p,8c6,16p,8g,16p,8e,16p,8a,8b,16a#,8a,16g.,16e6,16g6,8a6,16f6,8g6,8e6,16c6,16d6,8b,16p,8c6,16p,8g,16p,8e,16p,8a,8b,16a#,8a,16g.,16e6,16g6,8a6,16f6,8g6,8e6,16c6,16d6,8b,8p,16g6,16f#6,16f6,16d#6,16p,16e6,16p,16g#,16a,16c6,16p,16a,16c6,16d6,8p,16g6,16f#6,16f6,16d#6,16p,16e6,16p,16c7,16p,16c7,16c7,p,16g6,16f#6,16f6,16d#6,16p,16e6,16p,16g#,16a,16c6,16p,16a,16c6,16d6,8p,16d#6,8p,16d6,8p,16c6";

// char *startup_sound = "Startup:d=16,o=6,b=60:32c,32d,32e,32f,32g,32a,32b";

// char *startup_sound = "MissionImp:d=16,o=6,b=95:32d,32d#,32d,32d#,32d,32d#,32d,32d#,32d,32d,32d#,32e,32f,32f#,32g,g,8p,g,8p,a#,p,c7,p,g,8p,g,8p,f,p,f#,p,g,8p,g,8p,a#,p,c7,p,g,8p,g,8p,f,p,f#,p,a#,g,2d,32p,a#,g,2c#,32p,a#,g,2c,a#5,8c,2p,32p,a#5,g5,2f#,32p,a#5,g5,2f,32p,a#5,g5,2e,d#,8d";

SoundManagerClass soundManager;

void SoundManagerClass::_playRtttl(char *p)
{
    ...
    while (*p)
    {
        ...
        if (note)
        {
            _playNote(notes[(scale - 4) * 12 + note], duration);
        }
        else
        {
            delay(duration);
...
void SoundManagerClass::_playMelody(int *melody, size_t length, int tempo)
{
    ...
    for (int thisNote = 0; thisNote < notes * 2; thisNote = thisNote + 2)
    {
        ...
        // tone(_pin, melody[thisNote]);
        if (melody[thisNote] < 4979)
        {
            _playNote(melody[thisNote], noteDuration * 0.9);
            delay(noteDuration);
            noTone(_pin);
        }
        // _playNote(melody[thisNote], noteDuration * 0.9);
...
void SoundManagerClass::playStartup()
{
    _playMelody(startup_melody, 100);
}
void SoundManagerClass::playEspReady()
{
    _playMelody(esp_ready_melody, sizeof(esp_ready_melody) / sizeof(esp_ready_melody[0]) / 2, 100);
}
void SoundManagerClass::playStmReady()
{
    _playMelody(stm_ready_melody, 100);
}

void SoundManagerClass::playShutdown()
{
    _playMelody(shutdown_melody, 100);
}
// void SoundManagerClass::playError()
// {
//     _playSong(error_sound);
// }
// void SoundManagerClass::playWarning()
// {
//     _playSong(warning_sound);
// }
// void SoundManagerClass::playSuccess()
// {
//     _playSong(success_sound);
// }
// void SoundManagerClass::playInfo()
// {
//     _playSong(info_sound);
// }
// void SoundManagerClass::playAlarm()
// {
//     _playSong(alarm_sound);
// }

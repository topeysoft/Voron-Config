  ...
  <div>
      ...
      <div class="set overflow-hidden">
        ...
        >
          ...
          <a
            ...
            color="primary"
            v-ripple
            class="bg-primary right"
            @click="right"
          ></a>
          <a
            href="#"
            color=""
            @click.prevent="$event.stopPropagation(); $event.preventDefault();"
            @focus="$refs.up.focus()"
            :focusable="false"
            v-ripple
            class="bg-primary down"
            @click="down"
          ></a>
          <a
            color="primary"
    ...
    <div class="row justify-center">
      ...
      <q-btn-group>
        <q-btn
          :unelevated="true"
          :outline="autoNavigate"
          color="primary"
          class="no-shadow"
          @click="autoNavigate = !autoNavigate"
